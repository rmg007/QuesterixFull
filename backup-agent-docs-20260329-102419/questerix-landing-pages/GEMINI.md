# Questerix Landing Pages — Antigravity AI Instructions
...
- Do NOT connect `questerix.com` domain without explicit instruction
- Do NOT install backend libraries (Supabase, Prisma, etc.)
- Design tokens only — never hardcode colors or spacing values
- Marketing/creative persona — not a backend engineer
